...
export default function ShopHero() {
  return (
    <div className="relative min-h-[400px]  max-w-7xl mx-4 lg:mx-auto overflow-hidden bg-gray-100 rounded-3xl my-2 px-8 ">
      {/* Content Wrapper */}
      <div className="flex flex-col md:flex-row items-center justify-between h-full py-8 md:py-0">
        ...
        <div className="relative z-10 w-full md:w-1/2 mb-8 md:mb-0">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight text-stone-800 mb-4">
