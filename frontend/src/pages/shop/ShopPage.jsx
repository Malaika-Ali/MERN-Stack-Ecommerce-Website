...
//                   className={`p-3 rounded-full mx-1 text-sm ${currentPage === index + 1 ? 'bg-grey-color' : ''}`}
...
//               <FilterChips
//                 activeFilters={activeFilters}
//                 onRemoveFilter={(filterId) => setActiveFilters(activeFilters.filter(filter => filter.id !== filterId))}
//               />
//             </div>
